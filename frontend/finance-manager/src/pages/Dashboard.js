...
function Dashboard() {
    ...
    const fetchData = async () => {
        try {
            ...
            calculateTotals(incomeResponse.data.incomes, expenseResponse.data.expenses);
        } catch (error) {
    ...
    return (
        <div
            className={`dashboard relative min-h-screen transition-all duration-300 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'
                }`}
        >
            {/* Navigation Bar */}
            ...
            {/* Sidebar */}
            <div
                className={`fixed top-16 left-0 h-full bg-[#23275e] text-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
            ...
            {/* Content Section */}
            <div
                className={`transition-all duration-300 pt-24 ${sidebarOpen ? 'ml-64' : ''
                    }`}
            >
                {/* Profile Section */}
                <div
                    className={`profile flex items-center p-6 rounded-lg shadow-md mx-6 mb-6 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
                        }`}
                >
                    ...
                    <div className="ml-6">
                        {isEditing ? (
                            ...
                            <div>
                                ...
                                <p>Member since {user.createdYear}</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 p-6">
                    ...
                    >
                        ...
                        <p className="text-4xl font-extrabold mt-2">${totalIncome - totalExpense}</p>
                    </div>
                </div>
