    ...
    return (
        ...
        >
            ...
            <div className={`transition-all duration-300 pt-24 ${sidebarOpen ? 'ml-64' : ''}`}>
                <h1 className="text-2xl font-bold text-center mb-6 text-red-700">Expense Manager</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6 px-4">
                    ...
                    <div className={`p-4 rounded-lg shadow-md ${
                        ...
                        <h2 className="text-lg font-semibold text-red-600 mb-4">Add Expense</h2>
                ...
                <div className={`p-4 rounded-lg shadow-md mx-4 ${
                    ...
                    <h2 className="text-lg font-semibold mb-4 text-red-600">Expense Records</h2>
                    ...
                    {expenses.length === 0 && (
                        <p className="text-center text-gray-500 mt-4">No expense records found.</p>
                    )}
                </div>
            </div>
        </div>
